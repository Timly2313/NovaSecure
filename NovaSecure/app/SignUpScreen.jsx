...
const SignUpScreen = () => {
  ...
  // Validation for student email (after trimming and lowercasing)
  ...
  const handleSubmit = async () => {
    ...
    const trimmedEmail = email.trim().toLowerCase(); // also lowercase for consistent domain
    ...
    <ScreenWrapper bg="#f8fafc">
      ...
      <View style={styles.waveContainer}>
        <Animated.View
          style={[
            styles.wave,
            { transform: [{ translateY: wave1TranslateY }], opacity: 0.3 },
          ]}
        />
        <Animated.View
          style={[
            styles.wave,
            { transform: [{ translateY: wave2TranslateY }], opacity: 0.5 },
          ]}
        />
        <Animated.View
          style={[
            styles.wave,
            { transform: [{ translateY: wave3TranslateY }], opacity: 1 },
          ]}
        />
      </View>
      ...
      >
        <Animated.View
          style={[
            ...
            { opacity: fadeAnim, transform: [{ translateY: fadeTranslateY }] },
          ]}
        >
          <ScrollView
          ...
          >
            ...
            <View style={styles.logoContainer}>
              <Animated.View
                style={[styles.logo, { transform: [{ scale: bounceScale }] }]}
              >
